...
const data: {
...
}[] = [
  {
    ...
    items: [
      {
        icon: <Image src={ntnu_gdsc_logo_image} alt="GDSC NTNU Logo" width={logo_size} height={logo_size} />,
      ...
      {
        icon: <Image src={Open_House_NTUs_logo_image} alt="Open House NTUs Logo" width={logo_size} height={logo_size} />,
        name: "打開台大｜Open House NTUs",
        role: "Volunteer (Activities Section)",
        url: "https://www.facebook.com/openhousentus/?locale=zh_TW",
      },
      {
        icon: <Image src={ntnu_logo_image} alt="NTNU Logo" width={logo_size} height={logo_size} />,
        name: "社會教育學系｜Department of Adult and Continuing Education (National Taiwan Normal University)",
        role: "Ph.D. student",
        url: "https://www.ace.ntnu.edu.tw/",
      },
      {
        icon: <Image src={ntust_piano_club_logo_image} alt="NTUST Piano Club Logo" width={logo_size} height={logo_size} />,
  ...
  },
  {
    ...
    items: [
      {
        icon: <Image src={risingwave_logo_image} alt="RisingWave Logo" width={logo_size} height={logo_size} />,
        name: "RisingWave Labs",
        role: "Web Front-end Developer (Intern)",
        url: "https://risingwave.com/",
      },
      {
        icon: <Image src={pingcap_logo_image} alt="PingCAP Logo" width={logo_size} height={logo_size} />,
        name: "PingCAP",
        role: "Web Front-end Developer (Intern)",
        url: "https://pingcap.com/",
      },
      {
        icon: <Image src={ntu_gdsc_logo_image} alt="GDSC NTU Logo" width={logo_size} height={logo_size} />,
      ...
      {
        icon: <Image src={ntust_gdsc_logo_image} alt="GDSC NTUST Logo" width={logo_size} height={logo_size} />,
      ...
      {
        icon: <Image src={ntust_student_council_logo_image} alt="NTUST Student Council Logo" width={logo_size} height={logo_size} />,
      ...
      {
        icon: <Image src={ntust_student_association_logo_image} alt="NTUST Student Association Logo" width={logo_size} height={logo_size} />,
      ...
      {
        icon: <Image src={ntust_ece_logo_image} alt="NTUST ECE Logo" width={logo_size} height={logo_size} />,
      ...
      {
        icon: <Image src={ntust_logo_image} alt="NTUST Logo" width={logo_size} height={logo_size} />,
        name: "電子工程系｜Department of Electrical and Computer Engineering (National Taiwan University of Science and Technology)",
        role: "Bachelor's degree student",
        url: "https://ece.ntust.edu.tw/",
      },
      {
        icon: <Image src={wspc_logo_image} alt="WSPC Logo" width={logo_size} height={logo_size} />,
