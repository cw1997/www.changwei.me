...
}[] = [
  {
    ...
    items: [
      ...
      },
      {
        icon: (
          <Image
            src={Open_House_NTUs_logo_image.src}
            alt={""}
            width={logo_size}
            height={logo_size}
          />
      ...
      },
      {
        icon: (
          <Image
            src={ntust_piano_club_logo_image.src}
            alt={""}
            width={logo_size}
            height={logo_size}
          />
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        icon: (
          <Image
            src={ntust_student_council_logo_image.src}
            alt={""}
            width={logo_size}
            height={logo_size}
          />
      ...
      },
      {
        icon: (
          <Image
            src={ntust_student_association_logo_image.src}
            alt={""}
            width={logo_size}
            height={logo_size}
          />
