    ...
    items: [
      {
        ...
        note: (
          <>
            <ul>
              <li>
                Group of Electronic System.
                Research to optimize 5GC(5th-generation core network). Reading 3GPP specification to find the point of enhance/optimize the protocol of 5G telecommunication network.
              </li>
              <li>
                Group of Optoelectronic and Semiconductors.
                Research to build FSS(Frequency Selective Surface) and Microwave-Switch using Varactor Diode(Pin Diode) and LC(Liquid Crystal).
              </li>
            </ul>
          </>
        ),
          ...
          <>
            <ul>
              <li>
                ...
                <ul>
                  <li>A real-time OS(Operating System) written by C and ARM Cortex-M3 assembly language, <GithubOutlined /> <OutsideLink href={'https://github.com/cw1997/ez-rtos'}/></li>
                  <li><ZhihuCircleFilled /> <OutsideLink href={'https://zhuanlan.zhihu.com/p/350587132'}>从零开始写一个操作系统（一） —— 基本概念</OutsideLink></li>
                  <li><ZhihuCircleFilled /> <OutsideLink href={'https://zhuanlan.zhihu.com/p/350627431'}>从零开始写一个操作系统（二） —— startup 与 bootloader</OutsideLink></li>
              ...
              <li>
                ...
                <ul>
                  <li><GithubOutlined /> <OutsideLink href={'https://github.com/cw1997/SDRAM-Controller'}/></li>
                  <li><GithubOutlined /> <OutsideLink href={'https://github.com/risc-v-cpu'}/></li>
                  <li><GithubOutlined /> <OutsideLink href={'https://github.com/openx86'}/></li>
                </ul>
              </li>
              <li>
                Retrieve the network protocol specifications (RFC, IEEE, etc.), implement it by programming language.
                <ul>
                  <li><GithubOutlined /> <OutsideLink href={'https://github.com/cw1997/inetutils'} /></li>
                  <li><GithubOutlined /> <OutsideLink href={'https://github.com/cw1997/ez-mysql/tree/develop'} /></li>
                </ul>
              </li>
            </ul>
          </>
      ...
      },
      {
        ...
        location: 'Chinese mainland (+86), Hubei Province, Wuhan City (430000), Hanyang District',
        position: 'Software Engineering',
        note: (
          <>
            <ul>
              <li>
                Web backend development, including Java platform (JSP(Java Server Pages), Servlet, Spring framework & Spring MVC & Mybatis & Hibernate), Microsoft.NET platform (ASP.NET WebForm & ASP.NET MVC), PHP (Laravel), Python (Flask), Golang (Beego, gin)
              </li>
              <li>
                Web frontend development, including jQuery, Vue.js, React
              </li>
            </ul>
          </>
        ),
...
export const ExperienceSection: React.FunctionComponent<IPropsExperienceSection> = (props) => {
  return (
