...
export async function ExperienceSection(props: IPropsExperienceSection) {
  const t = await getTranslations("experience")

  const formatTimeEnd = (end: string) =>
    end === "now" ? t("now") : end

  const formatLocation = (loc: string) =>
    loc === "Remote" ? t("remote") : loc
                    ...
                    <div className={styles.item_info_meta}>
                      ...
                      >
                        <div>
                          ...
                          {formatTimeEnd(item.time_range.end)}
                        </div>
                        <div>
                          <EnvironmentOutlined />{" "}
