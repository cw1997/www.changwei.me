...
import {BilibiliOutlined, DiscordOutlined, FacebookOutlined, GithubOutlined, GitlabOutlined, InstagramOutlined, LinkedinOutlined, MailOutlined, QqOutlined, WechatOutlined, WeiboOutlined, XOutlined, YoutubeOutlined, ZhihuOutlined} from "@ant-design/icons";
import {faTelegram, faLine, faThreads, faDiscord, faFacebookMessenger} from "@fortawesome/free-brands-svg-icons";
...
}[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        content: (
          <img src={instagram_qrcode_image_url.src} alt={'https://instagram.com/changwei1997'}/>
        ),
      ...
      },
      {
        ...
        content: (
          <img src={zhihu_qrcode_image_url.src} alt={'https://www.zhihu.com/people/changwei1006'}/>
        ),
      ...
      {
        icon: (
          <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1496" width="16" height="16">
            <path d="M0 0m228.544 0l566.912 0q228.544 0 228.544 228.544l0 566.912q0 228.544-228.544 228.544l-566.912 0q-228.544 0-228.544-228.544l0-566.912q0-228.544 228.544-228.544Z" fill="#666666" p-id="1497"></path>
            <path
      ...
      {
        icon: (
          <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5764" width="16" height="16">
            <path
    ...
    items: [
      {
        ...
        contact: 'changwei1006',
        content: (
          <img src={wechat_qrcode_image_url.src} alt={'changwei1006'}/>
        ),
      ...
      },
      {
        ...
        contact: '867597730',
        content: (
          <img src={qq_qrcode_image_url.src} alt={'867597730'}/>
        ),
      ...
      },
      {
        ...
        contact: '+886-0912-***-***',
        content: (
          <img src={line_qrcode_image_url.src} alt={'https://line.me/ti/p/b_9gnmE0Ob'}/>
        ),
          ...
          <div key={category.category_name} className={styles.category}>
            ...
            <Space className={styles.list} size={8} wrap>
              {category.items.map((item, index) => (
                ...
                >
                  <OutsideLink className={styles.item} href={item.url ?? item.qrcode_image_url}>
