      ...
      <div className={styles.content}>
        <div className={styles.text}>
          <p className={styles.copyright}>
            © {year}, Chang Wei, All rights reserved. <br/>
            © {year}, 昌维 版权所有.
          </p>
          <div className={styles.nerd_info}>
            <p>
              <CodeOutlined /> Source code [<OutsideLink href={'https://github.com/cw1997/www.changwei.me'}>cw1997/www.changwei.me</OutsideLink>] is under <OutsideLink href={'https://www.apache.org/licenses/LICENSE-2.0'}>Apache License, Version 2.0 (Apache 2.0)</OutsideLink>
            </p>
            <p className={styles.copyright_github}>
              <GithubOutlined /> GitHub Repository: <OutsideLink href={'https://github.com/cw1997/www.changwei.me'}/>
            </p>
