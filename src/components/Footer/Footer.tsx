      ...
      <div className={styles.content}>
        <div className={styles.text}>
          ...
          <div className={styles.nerd_info}>
            <p>Source code [<OutsideLink href={'https://github.com/cw1997/www.changwei.me'}>cw1997/www.changwei.me</OutsideLink>] is under <OutsideLink href={'https://www.apache.org/licenses/LICENSE-2.0'}>Apache License, Version 2.0 (Apache 2.0)</OutsideLink></p>
            <p className={styles.copyright_github}>
              <span>GitHub Repository: <OutsideLink href={'https://github.com/cw1997/www.changwei.me'}/></span>
            </p>
            <p>
              <Space wrap>
